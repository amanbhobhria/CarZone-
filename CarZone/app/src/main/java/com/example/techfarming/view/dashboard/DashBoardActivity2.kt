...
import com.example.techfarming.view.articles.CarSuggestionFragment
...
import com.example.techfarming.view.introscreen.IntroActivity
...
class DashBoardActivity2 : AppCompatActivity() ,NavigationView.OnNavigationItemSelectedListener  {
    ...
    private lateinit var carSuggestionFragment: CarSuggestionFragment
...
//        ecommerceFragment=EcommerceFragment()
        ...
        bottomNav.setOnNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.bottomNavEcomm -> {
                    carSuggestionFragment = CarSuggestionFragment()
                    supportFragmentManager.beginTransaction().apply {
                        replace(R.id.frame_layout, carSuggestionFragment, "ecommItemFrag")
                        setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
                        setReorderingAllowed(true)
...
//            val allPosts = viewModel2.liveData3.value as ArrayList<DocumentSnapshot>
            ...
            Glide.with(this).load(R.drawable.caruserimg).into(navbarUserImage)
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.miItem1 -> {
                ...
                supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.frame_layout, carSuggestionFragment, "ecommListFrag")
                    .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
                    .setReorderingAllowed(true)
